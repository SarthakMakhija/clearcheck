...
fn assert_failed_inner(
    ...
    let operation = match kind {
        ...
        AssertKind::InRangeSize => "must have the size in the range provided by",
        AssertKind::NotInRangeSize => "must not have the size in the range provided by",
        AssertKind::ContainsKey => "must contain the key of",
        AssertKind::NotContainsKey => "must not contain the key of",
        AssertKind::ContainsValue => "must contain the value of",
        AssertKind::NotContainsValue => "must not contain the value of",
        AssertKind::ContainsKeyValue => "must contain the key/value of",
        AssertKind::NotContainsKeyValue => "must not contain the key/value of",
